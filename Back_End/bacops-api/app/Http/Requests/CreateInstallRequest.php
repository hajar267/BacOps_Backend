...
class CreateInstallRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'installation.beneficiary.nom' => ['nullable', 'required_if:installation.beneficiary.isFilled,true', 'string', 'min:1'],
            'installation.beneficiary.prenom' => ['nullable', 'required_if:installation.beneficiary.isFilled,true', 'string', 'min:1'],
            'installation.beneficiary.cin' => ['nullable', 'required_if:installation.beneficiary.isFilled,true', 'string', 'min:1'],
            'installation.beneficiary.telephone' => ['nullable', 'required_if:installation.beneficiary.isFilled,true', 'string', 'min:1'],
            'installation.beneficiary.isFilled' => ['sometimes', 'boolean'],
            'installation.beneficiary.signature1' => ['nullable', 'required_if:installation.beneficiary.isFilled,true', 'string'],
            'installation.beneficiary.signature2' => ['nullable', 'required_if:installation.beneficiary.isFilled,true', 'string'],
